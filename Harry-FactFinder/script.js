...
function showDefault(){
	...
	document.querySelector('section').style.backgroundColor = "#D1EFB5";
	...
	for(var i = 0; i < inputs.length; i++){
		...
		inputs[i].style.fontFamily = "Courier New";
	}
}
